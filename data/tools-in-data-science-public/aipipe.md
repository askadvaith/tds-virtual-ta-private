...
AI Pipe lets you build web apps that can access LLM APIs (e.g. OpenRouter, OpenAI etc.) without a back-end. It is a proxy service to OpenAI, Gemini and other such providers and allows you to run any model from these providers to a certain extent free of charge.
